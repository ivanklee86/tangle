...
func TestManifests(t *testing.T) {
	...
	t.Run("Test stiching yamls", func(t *testing.T) {
		manifests, err := assembleManifests(manifestsLive)
		assert.Nil(t, err)
	...
	t.Run("Test diffing yamls", func(t *testing.T) {
		live, _ := assembleManifests(manifestsLive)
		target, _ := assembleManifests(manifestsTarget)
